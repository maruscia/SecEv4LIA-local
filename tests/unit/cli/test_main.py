...
class TestMainCLI:
    ...
    def test_cli_help_output(self):
        ...
        expected_content = [
            "SecEv4LIA CLI - AI Agent Security Testing Tool",
            "Common Usage:",
            "secev init",
            "secev agent list",
    ...
    def test_verbose_flag_handling(self):
        ...
        for args, expected_level in test_cases:
            ...
            #     # Check that SECEV4LIA_VERBOSE is set to expected_level
...
class TestLogoIntegration:
    ...
    def test_logo_shown_on_attack_command(self):
        ...
        # In a real test:
        # runner = CliRunner()
        # with patch('secev4lia.utils.display_secev4lia_splash') as mock_splash:
