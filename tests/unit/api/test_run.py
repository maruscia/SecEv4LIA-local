...
from secev4lia.server.api.models import PaginatedRunList
from secev4lia.server.api.models import PatchedRunRequest  # Added
from secev4lia.server.api.models import Result  # For nested results within a Run
from secev4lia.server.api.models import (
    ResultRequest as RunResultCreateRequest,
)  # Alias to avoid confusion with main ResultRequest
from secev4lia.server.api.models import Run
from secev4lia.server.api.models import StatusEnum  # For run_list filter
from secev4lia.server.api.models import RunRequest  # Added
from secev4lia.server.types import UNSET


class TestRunListAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_list.AuthenticatedClient")
    def test_run_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.run.run_list.PaginatedRunList.model_validate",
...
class TestRunCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_create.AuthenticatedClient")
    def test_run_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.run.run_create.Run.model_validate",
...
class TestRunRetrieveAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_retrieve.AuthenticatedClient")
    def test_run_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.run.run_retrieve.Run.model_validate",
            return_value=mock_parsed_run,
        ) as mock_model_validate:
...
class TestRunUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_update.AuthenticatedClient")
    def test_run_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.run.run_update.Run.model_validate",
            return_value=mock_parsed_run,
        ) as mock_model_validate:
...
class TestRunPartialUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_partial_update.AuthenticatedClient")
    def test_run_partial_update_sync_detailed_success_patch_status_notes(
        ...
        with patch(
            "secev4lia.server.api.run.run_partial_update.Run.model_validate",
            return_value=mock_parsed_run,
        ) as mock_model_validate:
...
class TestRunDestroyAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_destroy.AuthenticatedClient")
...
class TestRunResultCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_result_create.AuthenticatedClient")
    def test_run_result_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.run.run_result_create.Result.model_validate",
...
class TestRunRunTestsCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.run.run_run_tests_create.AuthenticatedClient")
