...
from secev4lia.server.api.attack import (
    attack_create,
    attack_destroy,
    attack_list,
...
from secev4lia.server.api.models import Attack  # For individual attack items
from secev4lia.server.api.models import AttackRequest

# Assuming these are the correct import paths based on the project structure
from secev4lia.server.api.models import PaginatedAttackList
...
class TestAttackListAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_list.AuthenticatedClient")
    def test_attack_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.attack.attack_list.PaginatedAttackList.model_validate",
...
class TestAttackCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_create.AuthenticatedClient")
    def test_attack_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.attack.attack_create.Attack.model_validate",
...
class TestAttackRetrieveAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_retrieve.AuthenticatedClient")
    def test_attack_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.attack.attack_retrieve.Attack.model_validate",
            return_value=mock_parsed_attack,
        ) as mock_model_validate:
...
class TestAttackUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_update.AuthenticatedClient")
    def test_attack_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.attack.attack_update.Attack.model_validate",
            return_value=mock_parsed_attack,
        ) as mock_model_validate:
...
class TestAttackPartialUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_partial_update.AuthenticatedClient")
    def test_attack_partial_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.attack.attack_partial_update.Attack.model_validate",
            return_value=mock_parsed_attack,
        ) as mock_model_validate:
...
class TestAttackDestroyAPI(unittest.TestCase):
    @patch("secev4lia.server.api.attack.attack_destroy.AuthenticatedClient")
