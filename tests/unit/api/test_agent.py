...
from secev4lia.server.api.agent import (
    agent_create,
    agent_destroy,
    agent_list,
...
from secev4lia.router.types import AgentTypeEnum  # For AgentRequest body
...
from secev4lia.server.api.models import PaginatedAgentList
from secev4lia.server.api.models import (
    PatchedAgentRequest,
...
class TestAgentListAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_list.AuthenticatedClient")
    def test_agent_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.agent.agent_list.PaginatedAgentList.model_validate",
...
class TestAgentCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_create.AuthenticatedClient")
    def test_agent_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.agent.agent_create.Agent.model_validate",
...
class TestAgentRetrieveAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_retrieve.AuthenticatedClient")
    def test_agent_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.agent.agent_retrieve.Agent.model_validate",
            return_value=mock_parsed_agent,
        ) as mock_model_validate:
...
class TestAgentUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_update.AuthenticatedClient")
    def test_agent_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.agent.agent_update.Agent.model_validate",
            return_value=mock_parsed_agent,
        ) as mock_model_validate:
...
class TestAgentDestroyAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_destroy.AuthenticatedClient")
...
class TestAgentPartialUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.agent.agent_partial_update.AuthenticatedClient")
    def test_agent_partial_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.agent.agent_partial_update.Agent.model_validate",
            return_value=mock_parsed_agent,
        ) as mock_model_validate:
