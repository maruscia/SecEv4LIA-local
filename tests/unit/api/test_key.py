...
from secev4lia.server.api.key import key_create, key_destroy, key_list, key_retrieve
from secev4lia.server.api.models import PaginatedUserAPIKeyList
from secev4lia.server.api.models import UserAPIKey
from secev4lia.server.api.models import UserAPIKeyRequest


class TestKeyListAPI(unittest.TestCase):
    @patch("secev4lia.server.api.key.key_list.AuthenticatedClient")
    def test_key_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.key.key_list.PaginatedUserAPIKeyList.model_validate",
...
class TestKeyCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.key.key_create.AuthenticatedClient")
    def test_key_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.key.key_create.UserAPIKey.model_validate",
...
class TestKeyRetrieveAPI(unittest.TestCase):
    @patch("secev4lia.server.api.key.key_retrieve.AuthenticatedClient")
    def test_key_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.key.key_retrieve.UserAPIKey.model_validate",
            return_value=mock_parsed_key,
        ) as mock_model_validate:
...
class TestKeyDestroyAPI(unittest.TestCase):
    @patch("secev4lia.server.api.key.key_destroy.AuthenticatedClient")
