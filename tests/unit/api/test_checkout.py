...
from secev4lia.server.api.checkout import checkout_create
...
from secev4lia.server.api.models import CheckoutSessionResponse
from secev4lia.server.api.models import GenericErrorResponse
...
def test_sync_success(
    ...
    with patch(
        "secev4lia.server.api.checkout.checkout_create.sync_detailed",
...
async def test_asyncio_success(
    ...
    with patch(
        "secev4lia.server.api.checkout.checkout_create.asyncio_detailed",
