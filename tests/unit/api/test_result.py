...
from secev4lia.server.api.models import PaginatedResultList
from secev4lia.server.api.models import PatchedResultRequest
from secev4lia.server.api.models import Result
from secev4lia.server.api.models import ResultRequest
from secev4lia.server.api.models import (
    StepTypeEnum,
)  # Ensuring this import is present
from secev4lia.server.api.models import Trace
from secev4lia.server.api.models import TraceRequest  # For creating traces


class TestResultListAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_list.AuthenticatedClient")
    def test_result_list_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.result.result_list.PaginatedResultList.model_validate",
...
class TestResultCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_create.AuthenticatedClient")
    def test_result_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.result.result_create.Result.model_validate",
...
class TestResultRetrieveAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_retrieve.AuthenticatedClient")
    def test_result_retrieve_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.result.result_retrieve.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_update.AuthenticatedClient")
    def test_result_update_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.result.result_update.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultPartialUpdateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_partial_update.AuthenticatedClient")
    def test_result_partial_update_sync_detailed_success_patch_evaluation(
        ...
        with patch(
            "secev4lia.server.api.result.result_partial_update.Result.model_validate",
            return_value=mock_parsed_result,
        ) as mock_model_validate:
...
class TestResultDestroyAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_destroy.AuthenticatedClient")
...
class TestResultTraceCreateAPI(unittest.TestCase):
    @patch("secev4lia.server.api.result.result_trace_create.AuthenticatedClient")
    def test_result_trace_create_sync_detailed_success(self, MockAuthenticatedClient):
        ...
        with patch(
            "secev4lia.server.api.result.result_trace_create.Trace.model_validate",
