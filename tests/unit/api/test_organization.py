...
from secev4lia.server.api.organization import (
    organization_create,
...
from secev4lia.errors import UnexpectedStatus
from secev4lia.server.api.models import Organization
from secev4lia.server.api.models import OrganizationRequest
from secev4lia.server.api.models import PaginatedOrganizationList
from secev4lia.server.api.models import PatchedOrganizationRequest
...
def test_create_sync_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_create.sync_detailed",
...
async def test_create_asyncio_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_create.asyncio_detailed",
...
def test_list_sync_success(authenticated_client: AuthenticatedClient):
    ...
    with patch(
        "secev4lia.server.api.organization.organization_list.sync_detailed",
        return_value=mock_detailed_response,
    ) as mock_sync_detailed:
...
async def test_list_asyncio_success(authenticated_client: AuthenticatedClient):
    ...
    with patch(
        "secev4lia.server.api.organization.organization_list.asyncio_detailed",
        new=mock_asyncio_detailed_func,
    ) as _:
...
def test_me_retrieve_sync_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_me_retrieve.sync_detailed",
        return_value=mock_detailed_response,
    ) as mock_sync_detailed:
...
async def test_me_retrieve_asyncio_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_me_retrieve.asyncio_detailed",
        new=mock_asyncio_detailed_func,
    ) as _:
...
def test_partial_update_sync_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_partial_update.sync_detailed",
        return_value=mock_detailed_response,
    ) as mock_sync_detailed:
...
async def test_partial_update_asyncio_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_partial_update.asyncio_detailed",
        new=mock_asyncio_detailed_func,
    ) as _:
...
def test_retrieve_sync_success_specific_org(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_retrieve.sync_detailed",
        return_value=mock_detailed_response,
    ) as mock_sync_detailed:
...
async def test_retrieve_asyncio_success_specific_org(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_retrieve.asyncio_detailed",
        new=mock_asyncio_detailed_func,
    ) as _:
...
def test_update_sync_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_update.sync_detailed",
        return_value=mock_detailed_response,
    ) as mock_sync_detailed:
...
async def test_update_asyncio_success(
    ...
    with patch(
        "secev4lia.server.api.organization.organization_update.asyncio_detailed",
        new=mock_asyncio_detailed_func,
    ) as _:
