# Contributing to SecEv4LIA

First off, thank you for considering contributing to SecEv4LIA! It's people like you that make SecEv4LIA such a great tool. We welcome contributions of all kinds, from bug reports and feature requests to documentation improvements and code contributions.
...
This project and everyone participating in it is governed by the [SecEv4LIA Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [ais@ai4i.it](mailto:ais@ai4i.it).
...
This section guides you through submitting a bug report for SecEv4LIA. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior, and find related reports.
...
*   **Provide Details:** Explain the problem and include additional details to help maintainers reproduce the problem:
    ...
    *   Include details about your environment (Python version, OS, SecEv4LIA version).

### Suggesting Enhancements

This section guides you through submitting an enhancement suggestion for SecEv4LIA, including completely new features and minor improvements to existing functionality.
...
Unsure where to begin contributing to SecEv4LIA? You can start by looking through `good first issue` and `help wanted` issues:

*   [Good first issues](https://github.com/AISecurityLab/secev4lia/labels/good%20first%20issue) - issues which should only require a few lines of code, and a test or two.
*   [Help wanted issues](https://github.com/AISecurityLab/secev4lia/labels/help%20wanted) - issues which should be a bit more involved than `good first issue` issues.

### Pull Requests

The process described here has several goals:

*   Maintain SecEv4LIA's quality
*   Fix problems that are important to users
*   Engage the community in working toward the best possible SecEv4LIA
*   Enable a sustainable system for SecEv4LIA's maintainers to review contributions
...
6.  **Push your branch** to your fork on GitHub.
    ...
    ```
7.  **Open a Pull Request** to the `main` branch of the `AISecurityLab/secev4lia` repository.
...
By contributing to SecEv4LIA, you agree that your contributions will be licensed under its [Apache License 2.0](LICENSE).
