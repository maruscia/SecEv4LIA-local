...
SecEv4LIA is a powerful security testing framework designed to help identify vulnerabilities in AI systems. With this power comes responsibility. This guide outlines the ethical and legal considerations for using SecEv4LIA responsibly.
...
Before using SecEv4LIA, ensure you can answer **YES** to all these questions:
...
### 1. Initial Discovery
When you discover a vulnerability using SecEv4LIA:
...
SecEv4LIA (an open-source AI security testing framework).
...
### For Security Teams
If you're using SecEv4LIA within an organization:
...
### Academic Research
When using SecEv4LIA for academic research:
...
For questions about responsible use of SecEv4LIA, contact our security team at [ais@ai4i.it](mailto:ais@ai4i.it). 